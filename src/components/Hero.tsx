...
export const Hero: React.FC<HeroProps> = ({
  ...
  return (
    <section className="relative overflow-hidden pt-6 pb-12 sm:pt-14 sm:pb-24 border-b border-zinc-900 bg-[#030303] w-full max-w-[100vw]">
      {/* Background Video in Absolute Position with Subtle Mobile Texture */}
      <video
        ...
        loop
        playsInline
        className="absolute inset-0 w-full h-full object-cover pointer-events-none opacity-25 md:opacity-100 brightness-95 md:brightness-90 contrast-105 md:contrast-110 z-0"
      >
        <source src="/publichero-bg.mp4" type="video/mp4" />
        <source src="/hero-bg.mp4" type="video/mp4" />
      </video>

      {/* Dark Combat Luxury Solid Gradient Overlay: Deep solid black/asphalt on mobile, cinema depth on desktop */}
      <div className="absolute inset-0 bg-gradient-to-b from-[#030303]/90 via-[#030303]/80 to-[#030303] md:from-black/50 md:via-black/40 md:to-black/75 pointer-events-none z-0" />

      {/* 1. Dramatic Ring Spotlights (Crossed angular beams - optimized for mobile) */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-[450px] sm:h-[650px] bg-ring-spotlight pointer-events-none opacity-30 sm:opacity-80 animate-spotlight-pulse z-[1]" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-10 items-center mb-8 sm:mb-14">
          ...
          <div className="lg:col-span-7 space-y-4 sm:space-y-6 text-left">
            ...
            {/* Tactical Action Buttons (Dual CTAs with chamfered cuts and solid contrast) */}
            <div className="pt-2 sm:pt-3 flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
              <button
                onClick={onStartTriage}
                className="relative group overflow-hidden px-5 sm:px-8 py-3.5 sm:py-4 bg-gradient-to-r from-blood-700 via-blood-600 to-blood-800 hover:from-blood-600 hover:to-blood-700 text-white font-combat uppercase tracking-wider text-base sm:text-xl lg:text-2xl font-black shadow-spotlight-sharp transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] clip-chamfer-top border border-blood-500/50 flex items-center justify-center gap-3"
              >
            ...
            {/* Micro-guarantees (Benefits with clean line spacing and no overlap) */}
            <div className="flex flex-wrap items-center gap-x-4 sm:gap-x-6 gap-y-2 text-[11px] sm:text-xs font-tactical uppercase tracking-wider text-zinc-400 pt-2 sm:pt-3">
          ...
          {/* Right Column: Official Logo Showcase with Red LED Backlighting Effects and Dedicated Mobile Breathing Room */}
          <div className="lg:col-span-5 flex items-center justify-center py-4 sm:py-0">
            <div className="relative w-full max-w-[220px] sm:max-w-sm lg:max-w-md aspect-square flex items-center justify-center my-2 sm:my-0">
              ...
              <div className="absolute -top-1 sm:-top-2 left-1 sm:left-4 z-20 bg-asphalt-900/95 border border-blood-600 px-2 sm:px-3 py-0.5 sm:py-1 clip-tag shadow-spotlight-sharp">
              ...
              <div className="absolute -bottom-1 sm:-bottom-2 right-1 sm:right-4 z-20 bg-[#09090b] border border-blood-600/80 px-2 sm:px-3 py-0.5 sm:py-1 clip-tag shadow-spotlight-sharp">
