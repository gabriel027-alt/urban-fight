...
export const MarqueeTicker: React.FC<MarqueeTickerProps> = ({
  ...
  return (
    <div className="w-full max-w-[100vw] overflow-hidden py-2 sm:py-3">
      <div className={`relative w-full overflow-hidden py-3.5 z-20 select-none transform ${angle} scale-105 my-3 sm:my-6 ${getThemeStyles()}`}>
