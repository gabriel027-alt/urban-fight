    ...
    <div className="sm:hidden fixed bottom-0 left-0 right-0 z-50 p-2.5 bg-[#050505]/98 backdrop-blur-xl border-t border-zinc-800 shadow-2xl animate-in slide-in-from-bottom duration-300 w-full max-w-[100vw] overflow-hidden">
      <div className="flex items-center gap-2">
        <button
          ...
          className="flex-1 py-3 px-4 bg-gradient-to-r from-blood-700 via-blood-600 to-blood-800 text-white font-combat uppercase tracking-wider text-lg font-black clip-chamfer-top flex items-center justify-center gap-2 shadow-spotlight-sharp active:scale-95 transition-all"
        >
        ...
        <a
          ...
          className="w-12 h-12 bg-emerald-600 hover:bg-emerald-500 text-white flex items-center justify-center shadow-lg clip-tag active:scale-95 transition-transform shrink-0"
