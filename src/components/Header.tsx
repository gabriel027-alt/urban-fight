      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <div className="hidden sm:flex items-center gap-3">
            <button
              ...
              className="px-5 py-2.5 bg-gradient-to-r from-blood-700 via-blood-600 to-blood-800 hover:from-blood-600 hover:to-blood-700 text-white font-combat uppercase tracking-wider text-lg font-bold shadow-spotlight-sharp transition-all clip-chamfer-top border border-blood-500/50 flex items-center gap-2"
            >
          ...
          <button
            ...
            className="lg:hidden p-2 bg-asphalt-900 border border-zinc-800 text-zinc-300 hover:text-white"
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden bg-[#070709] border-b border-zinc-800 px-4 pt-3 pb-6 space-y-4 animate-in fade-in duration-150">
            <div className="p-2.5 bg-asphalt-900 border border-zinc-800 text-xs font-tactical text-zinc-300 flex items-center gap-2">
            ...
            <nav className="flex flex-col space-y-2">
              {navLinks.map((link) => (
                <button
                  ...
                  className="text-left py-2.5 px-3 font-tactical text-sm uppercase tracking-wider font-bold text-zinc-200 hover:bg-asphalt-800 hover:text-blood-400 transition-colors"
                >
                  {link.name}
                </button>
              ))}
            ...
            <div className="pt-2 border-t border-zinc-800">
              <button
                onClick={handleCtaClick}
                className="w-full py-3.5 bg-blood-600 hover:bg-blood-500 font-combat uppercase tracking-wider text-xl font-black text-white flex items-center justify-center gap-2 clip-chamfer-top shadow-spotlight-sharp"
              >
